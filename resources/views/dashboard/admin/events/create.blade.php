...
<div class="container-fluid p-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 fw-bold text-dark">Add Event</h1>
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="subheading" id="subheading" rows="3" class="form-control @error('subheading') is-invalid @enderror">{{ old('subheading') }}</textarea>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="location" id="location" class="form-control @error('location') is-invalid @enderror" value="{{ old('location') }}" placeholder="e.g. Main Auditorium">
                                @error('location') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-6">
                                <label for="event_type" class="form-label fw-bold">Event Type</label>
                                <input type="text" name="event_type" id="event_type" class="form-control @error('event_type') is-invalid @enderror" value="{{ old('event_type') }}" placeholder="e.g. Social, Academic">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" name="start_date_and_time" id="start_date_and_time" class="form-control @error('start_date_and_time') is-invalid @enderror" value="{{ old('start_date_and_time') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" name="end_date_and_time" id="end_date_and_time" class="form-control @error('end_date_and_time') is-invalid @enderror" value="{{ old('end_date_and_time') }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card bg-light border-0">
                            <div class="card-body">
                                ...
                                <div class="form-text small">Provide a direct URL or upload. Upload overrides URL.</div>
                            </div>
                        </div>
                    </div>
                </div>

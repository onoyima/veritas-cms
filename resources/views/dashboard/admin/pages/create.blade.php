...
<head>
    ...
    <title>Create Page - Veritas CMS</title>
            ...
            <div class="bg-white rounded-lg shadow p-6 max-w-2xl">
                <form action="{{ route('admin.pages.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="slug" id="slug" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="auto-generated-if-empty" value="{{ old('slug') }}">

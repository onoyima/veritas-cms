...
<div class="container-fluid p-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 fw-bold text-dark">Add Student Group</h1>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
            <form action="{{ route('admin.student-groups.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="member_count" id="member_count" class="form-control @error('member_count') is-invalid @enderror" value="{{ old('member_count') }}" placeholder="e.g. 50+">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card bg-light border-0">
                            <div class="card-body">
                                ...
                                <div class="form-text small">Upload an image representing the group.</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end gap-2 border-top pt-4">
                    ...
                    <button type="submit" class="btn btn-primary px-4">Save Group</button>
                </div>
            </form>
        </div>
    </div>

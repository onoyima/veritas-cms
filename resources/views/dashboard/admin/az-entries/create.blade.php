...
<div class="container-fluid p-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 fw-bold text-dark">Add A-Z Entry</h1>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
            <form action="{{ route('admin.az-entries.store') }}" method="POST">
                @csrf
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="link" id="link" class="form-control @error('link') is-invalid @enderror" value="{{ old('link') }}" placeholder="/about or https://example.com">
                        ...
                        <div class="card bg-light border-0 mb-4">
                            <div class="card-body">
                                ...
                                <div class="alert alert-info small mb-0">
                                    ...
                                    The alphabet index (e.g. 'A', 'B') will be automatically determined from the first letter of the Topic Name.
                                </div>
                            </div>
                        </div>
                    </div>

...
<div class="container-fluid p-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 fw-bold text-dark">Add Mass Schedule</h1>
                    ...
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <select name="day" id="day" class="form-select @error('day') is-invalid @enderror" required>
                                ...
                                <option value="Daily" {{ old('day') == 'Daily' ? 'selected' : '' }}>Daily</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="invitees" id="invitees" rows="3" class="form-control @error('invitees') is-invalid @enderror" placeholder="e.g. Students, Staff, General Public">{{ old('invitees') }}</textarea>

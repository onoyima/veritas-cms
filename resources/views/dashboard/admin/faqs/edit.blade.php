...
<div class="container-fluid p-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 fw-bold text-dark">Edit FAQ</h1>
                        ...
                        <div class="card bg-light border-0 mb-4">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="category" id="category" class="form-control @error('category') is-invalid @enderror" value="{{ old('category', $faq->category) }}" placeholder="e.g. General, Admissions">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="is_active" id="status" class="form-select">
                                        <option value="active" {{ old('is_active', $faq->is_active->value ?? '') == 'active' ? 'selected' : '' }}>Active</option>
                                        <option value="inactive" {{ old('is_active', $faq->is_active->value ?? '') == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                    </select>
                                </div>
                            </div>
                        </div>

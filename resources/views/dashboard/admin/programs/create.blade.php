...
<div class="container-fluid p-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 fw-bold text-dark">Add Program</h1>
                    ...
                    <div class="col-md-8">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <select name="program_category" id="program_category" class="form-select @error('program_category') is-invalid @enderror">
                                            <option value="undergraduate" {{ old('program_category') == 'undergraduate' ? 'selected' : '' }}>Undergraduate</option>
                                            <option value="postgraduate" {{ old('program_category') == 'postgraduate' ? 'selected' : '' }}>Postgraduate</option>
                                            <option value="short-course" {{ old('program_category') == 'short-course' ? 'selected' : '' }}>Short Course</option>
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="program_level" id="program_level" class="form-control @error('program_level') is-invalid @enderror" value="{{ old('program_level') }}" placeholder="e.g. 100-400">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="degree" id="degree" class="form-control @error('degree') is-invalid @enderror" value="{{ old('degree') }}" placeholder="e.g. B.Sc, M.Sc">
                                        @error('degree') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>
                                    <div class="col-md-6">
                                        <label for="faculty" class="form-label fw-bold">Faculty</label>
                                        <input type="text" name="faculty" id="faculty" class="form-control @error('faculty') is-invalid @enderror" value="{{ old('faculty') }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" name="accredited_students" id="accredited_students" class="form-control @error('accredited_students') is-invalid @enderror" value="{{ old('accredited_students') }}" min="0">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="program_description" id="program_description" rows="5" class="form-control">{{ old('program_description') }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="eligibility_criteria" class="form-label fw-bold">Eligibility Criteria</label>
                                <textarea name="eligibility_criteria" id="eligibility_criteria" rows="5" class="form-control">{{ old('eligibility_criteria') }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="how_to_apply" class="form-label fw-bold">How to Apply</label>
                                <textarea name="how_to_apply" id="how_to_apply" rows="5" class="form-control">{{ old('how_to_apply') }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="financial_aid" class="form-label fw-bold">Financial Aid</label>
                                <textarea name="financial_aid" id="financial_aid" rows="5" class="form-control">{{ old('financial_aid') }}</textarea>
                            </div>
                            
                            <div class="mb-3">
                                <label for="research_facilities" class="form-label fw-bold">Research Facilities</label>
                                <textarea name="research_facilities" id="research_facilities" rows="5" class="form-control">{{ old('research_facilities') }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label for="transfer_candidates" class="form-label fw-bold">Transfer Candidates Info</label>
                                <textarea name="transfer_candidates" id="transfer_candidates" rows="5" class="form-control">{{ old('transfer_candidates') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card bg-light border-0">
                            <div class="card-body">
                                ...
                                <div class="form-text small">Upload an image for the program.</div>
                            </div>
                        </div>
                    </div>
                </div>

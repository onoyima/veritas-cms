...
<head>
    ...
    <title>Student Login - Veritas CMS</title>
...
<body class="bg-gray-50 h-screen w-full flex overflow-hidden">
    ...
    <div class="hidden lg:flex w-1/2 bg-brand-green items-center justify-center relative overflow-hidden">
        <div class="absolute inset-0 bg-[url('https://res.cloudinary.com/dbhjueg2l/image/upload/v1745492279/MTG-4591_e2a3hv.jpg')] bg-cover bg-center opacity-20"></div>
        <div class="relative z-10 text-white text-center px-12 max-w-2xl">
            ...
            <p class="text-xl text-green-100 leading-relaxed font-light">
                Welcome to the Student Portal. <br>
                Access your academic profile, courses, and campus resources.
            </p>
        </div>
        <!-- Decoration -->
        <div class="absolute -bottom-24 -left-24 w-96 h-96 bg-blue-800 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-pulse"></div>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white relative">
        <div class="max-w-md w-full space-y-8">
            <div class="text-center lg:text-left">
                <span class="bg-blue-100 text-brand-blue text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">Student Access</span>
                <h2 class="mt-4 text-3xl font-bold text-gray-900 tracking-tight">Student Login</h2>
            ...
            <form class="mt-8 space-y-6" method="POST" action="{{ route('student.login') }}">
                @csrf
                <div class="space-y-5">
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input id="email" name="email" type="email" autocomplete="email" required 
                                class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition duration-150 ease-in-out placeholder-gray-400" 
                                placeholder="student@veritas.edu.ng">
                        </div>
                        @error('email')
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="#" class="font-medium text-brand-blue hover:text-blue-800 transition-colors">Forgot password?</a>
                    </div>
                </div>

                <div>
                    <button type="submit" class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-bold rounded-lg text-white bg-brand-blue hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
            ...
            <div class="mt-8 border-t border-gray-100 pt-6 text-center">
                <p class="text-sm text-gray-500">
                    ...
                    <a href="{{ route('staff.login') }}" class="font-bold text-brand-green hover:text-green-800 transition-colors ml-1">
